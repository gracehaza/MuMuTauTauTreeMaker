    ...
    def runTauID(self):
        ...
        if "2017v1" in self.toKeep:
            ...
            self.process.rerunDiscriminationByIsolationOldDMMVArun2017v1raw = patDiscriminationByIsolationMVArun2v1raw.clone(
                PATTauProducer = self.cms.InputTag('slimmedTausMuonCleanedMedium'),
        ...
        if "deepTau2017v1" in self.toKeep:
            ...
            self.process.deepTau2017v1 = self.cms.EDProducer("DeepTauId",
                ...
                taus                   = self.cms.InputTag('slimmedTausMuonCleanedMedium'),
        ...
        if "deepTau2017v2p1" in self.toKeep:
            ...
            self.process.MuonClusterClean = self.cms.EDProducer("MuonClusterClean",
                    ...
                    TauTag  = self.cms.InputTag("slimmedTausMuonCleanedMedium"),
                    ParticleFlowCandTag = self.cms.InputTag("packedPFCandidates"),
                    muonID  = self.cms.string('medium'),
