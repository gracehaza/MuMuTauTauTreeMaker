       ...
       if (fabs(iParticle->pdgId()) == 15 && fabs(iParticle->mother()->pdgId()) != 15)
       {
           ...
           for (int iDaughter=0; iDaughter<nDaughters; iDaughter++)
           {
               ...
               if (fabs(dauId) == 15)
               {
                   ...
                   checkTauDecayMode(iParticle->daughter(iDaughter), tauHadCand, tauLepDecayVeto);
...
void GenTauHadCandSelector::checkTauDecayMode(const reco::Candidate* inputDaughter, std::vector<const reco::Candidate*>& daughterCand, bool& tauLepDecayVeto)
{
    ...
    for (int iGrandDaughter = 0; iGrandDaughter < nGrandDaughters; iGrandDaughter++)
    {
        ...
        {
            checkTauDecayMode(inputDaughter->daughter(iGrandDaughter), daughterCand, tauLepDecayVeto);
