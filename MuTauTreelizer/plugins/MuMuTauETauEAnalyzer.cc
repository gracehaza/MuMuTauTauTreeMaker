// -*- C++ -*-
//
// Package:    testED/MuMuTauETauEAnalyzer
// Class:      MuMuTauETauEAnalyzer
// 
/**\class MuMuTauETauEAnalyzer MuMuTauETauEAnalyzer.cc testED/MuMuTauETauEAnalyzer/plugins/MuMuTauETauEAnalyzer.cc
...
class MuMuTauETauEAnalyzer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit MuMuTauETauEAnalyzer(const edm::ParameterSet&);
      ~MuMuTauETauEAnalyzer();
...
//
MuMuTauETauEAnalyzer::MuMuTauETauEAnalyzer(const edm::ParameterSet& iConfig):
...
void
MuMuTauETauEAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
MuMuTauETauEAnalyzer::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
MuMuTauETauEAnalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MuMuTauETauEAnalyzer);
