// -*- C++ -*-
//
// Package:    testED/MuMuTauMuTauEAnalyzer
// Class:      MuMuTauMuTauEAnalyzer
// 
/**\class MuMuTauMuTauEAnalyzer MuMuTauMuTauEAnalyzer.cc testED/MuMuTauMuTauEAnalyzer/plugins/MuMuTauMuTauEAnalyzer.cc
...
class MuMuTauMuTauEAnalyzer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit MuMuTauMuTauEAnalyzer(const edm::ParameterSet&);
      ~MuMuTauMuTauEAnalyzer();
...
//
MuMuTauMuTauEAnalyzer::MuMuTauMuTauEAnalyzer(const edm::ParameterSet& iConfig):
...
void
MuMuTauMuTauEAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
MuMuTauMuTauEAnalyzer::beginJob()
{
...
void 
MuMuTauMuTauEAnalyzer::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
MuMuTauMuTauEAnalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MuMuTauMuTauEAnalyzer);
