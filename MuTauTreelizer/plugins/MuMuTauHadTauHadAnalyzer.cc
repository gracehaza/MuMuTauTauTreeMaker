// -*- C++ -*-
//
// Package:    testED/MuMuTauHadTauHadAnalyzer
// Class:      MuMuTauHadTauHadAnalyzer
// 
/**\class MuMuTauHadTauHadAnalyzer MuMuTauHadTauHadAnalyzer.cc testED/MuMuTauHadTauHadAnalyzer/plugins/MuMuTauHadTauHadAnalyzer.cc
...
class MuMuTauHadTauHadAnalyzer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit MuMuTauHadTauHadAnalyzer(const edm::ParameterSet&);
      ~MuMuTauHadTauHadAnalyzer();
...
//
MuMuTauHadTauHadAnalyzer::MuMuTauHadTauHadAnalyzer(const edm::ParameterSet& iConfig):
...
void
MuMuTauHadTauHadAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
MuMuTauHadTauHadAnalyzer::beginJob()
{
...
void 
MuMuTauHadTauHadAnalyzer::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
MuMuTauHadTauHadAnalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MuMuTauHadTauHadAnalyzer);
